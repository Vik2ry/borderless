...
class User(models.Model):
    ...
    handle = models.CharField(max_length=128, unique=True)  # email or phone
    created_at = models.DateTimeField(default=timezone.now)

    def __str__(self): return self.handle
...
class Transaction(models.Model):
    ...
    rate = models.DecimalField(max_digits=20, decimal_places=8, null=True, blank=True)  # to_currency per 1 from_currency
